		...
		<div class="col-12 p-0">
			...
			<div class="row">
				<div class="col-12 p-0">
					<nav class="nav bg-nav">
						...
						<a class="nav-link text-white" href="{{route('home.msg')}}">Messages d'utilisateurs</a>
			...
			<div class="bg-white">
				<div class="row mt-4 ml-4">
					<div class="col-12 p-0">
						<a class="ml-4 mt-2" href="{{route('home.create')}}"><h2>Ajouter un nouveau dessin</h2></a>
					</div>
				</div>
					...
					<div class="col-10 p-0">
						<table class="table table-striped">
							...
							<tbody>
								<tr>
									<th>{{$galerie->titre}}</th>
									<td class="d-none d-md-block">{{$galerie->description}}</td>
									<td>{{$galerie->categorie}}</td>
									<td><a href="{{route('home.edit', [$galerie->id])}}"><span><svg class="icon-size" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
										<path d="M17.414 2.586a2 2 0 00-2.828 0L7 10.172V13h2.828l7.586-7.586a2 2 0 000-2.828z" />
										<path fill-rule="evenodd" d="M2 6a2 2 0 012-2h4a1 1 0 010 2H4v10h10v-4a1 1 0 112 0v4a2 2 0 01-2 2H4a2 2 0 01-2-2V6z" clip-rule="evenodd" />
									</svg></span></a>
									<form method="POST" action="{{route('home.destroy', [$galerie->id])}}">
									@csrf
									@method("DELETE")
