		...
		<div class="col-12 p-0 m-0">
			...
			<div class="row">
				<div class="col-12 p-0 m-0">
					<nav class="navbar navbar-expand-lg bg-nav">
						...
						<!--Logo Accueil-->
						<a class="navbar-brand nav-link active text-white selector" aria-current="page" href="<?php echo e(route('galeries.index')); ?>#">Galerie</a>
						<!--menu burger-->
						<button
			...
			<div class="container">
                ...
                <?php $__currentLoopData = $galeries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $galerie): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
					<div class="position-relative card-pos p-0 mb-3" data-categorie="<?php echo e($galerie->categorie); ?>">
						<div class="card card-style">
							<!--<img src="<?php echo e(Storage::disk('uploads')->url($galerie->id)); ?>" class="card-img-top" alt="Meow">-->
							<img src="<?php echo e($galerie->emplacement); ?>" class="card-img-top img-size" alt="Meow">
							<div class="card-body bg-card">
								<h5 class="card-title"><?php echo e($galerie->titre); ?></h5>
								<span class="pos">
									<a href="<?php echo e(route('galeries.show', [$galerie->id])); ?>" class="btn btn-color text-white btn-size">PLUS</a>
								</span>
							</div>
						</div>
					</div>
...
</html><?php /**PATH /home/ylisdra/projet/resources/views/galeries/index.blade.php ENDPATH**/ ?>