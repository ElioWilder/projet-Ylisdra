		...
		<div class="col-12 p-0">
			...
			<div class="row">
				<div class="col-12 p-0">
					<nav class="nav bg-nav">
						...
						<a class="nav-link text-white offset-2" href="#">Déconnexion</a>
					</nav>
				</div>
			</div>
			...
			<div class="bg-white">
				<div class="row mt-4 ml-4">
					<div class="col-12 p-0">
						<a class="ml-4 mt-2" href="<?php echo e(route('home.create')); ?>"><h1>Ajouter un nouveau dessin</h1></a>
					</div>
				</div>
					...
					<div class="col-10 p-0">
						<table class="table table-striped">
							...
							<tbody>
								<tr>
									<th>Blabla</th>
									<td class="d-none d-md-block">blasjdehsljdcvsfvkjfv</td>
									<td>blabla</td>
									...
									<a href="<?php echo e(route('home.destroy', [$galerie->id])); ?>"><span><svg class="icon-size" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
