		...
		<div class="col-12 p-0">
			...
			<div class="row pt-4 pl-5">
				<div class="col-10 bg-white">
					...
					<a type="button" href="<?php echo e(route('home')); ?>" class="btn btn-color text-white">Retour</a>
				</div>
			</div>
		</div>
	</div>
...
</html><?php /**PATH /home/ylisdra/projet/resources/views/galeries/create.blade.php ENDPATH**/ ?>